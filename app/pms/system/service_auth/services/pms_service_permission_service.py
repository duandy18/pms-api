...
from app.pms.system.service_auth.repos import PmsServicePermissionRepo
...
class PmsServicePermissionService:
    ...
    def __init__(
        self,
        db: Session,
        repo: PmsServicePermissionRepo | None = None,
    ) -> None:
        self.repo = repo or PmsServicePermissionRepo(db)
